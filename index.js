...
function lowCSound() {
  const lowCSound = new Audio("./piano-c.mp3");
  lowCSound.play();
}

function lowDSound() {
  const lowDSound = new Audio("./piano-d.mp3");
  lowDSound.play();
}

function lowESound() {
  const lowESound = new Audio("./piano-e.mp3");
  lowESound.play();
}

function lowFSound() {
  const lowFSound = new Audio("./piano-f.mp3");
  lowFSound.play();
}

function lowGSound() {
  const lowGSound = new Audio("./piano-g.mp3");
  lowGSound.play();
}

function lowASound() {
  const lowASound = new Audio("./piano-a.mp3");
  lowASound.play();
}

function lowBSound() {
  const lowBSound = new Audio("./piano-b.mp3");
  lowBSound.play();
}

function highCSound() {
  const highCSound = new Audio("./piano-high-c.mp3");
  highCSound.play();
}

function highDSound() {
  const highDSound = new Audio("./piano-high-d.mp3");
  highDSound.play();
}

function highESound() {
  const highESound = new Audio("./piano-high-e.mp3");
  highESound.play();
}
